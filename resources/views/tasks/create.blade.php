...
<div class="max-w-2xl mx-auto">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-900">Создать задачу</h1>
        <p class="mt-2 text-gray-600">Заполните форму для создания новой задачи</p>
    </div>
    ...
    <form method="POST" action="{{ route('tasks.store') }}" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" name="subject" id="subject" required
                   ...
                   value="{{ old('subject') }}" placeholder="Введите название задачи">
            @error('subject')
        ...
        <div>
            ...
            <textarea name="description" id="description" rows="4"
                      ...
                      placeholder="Опишите задачу подробнее">{{ old('description') }}</textarea>
            @error('description')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="flex justify-end space-x-3">
            ...
            <button type="submit" 
                ...
                <i class="fas fa-save mr-2"></i>Создать задачу
            </button>
        </div>
    </form>
</div>
